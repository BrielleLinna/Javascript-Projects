function Ride_Function() { //naming function
    ...
    Can_ride=(Height <=51)? "You are too short":"You are tall enough"; //creating variable value to be compared
...
function Vote_Function() { //creating voting function
    ...
    Can_Vote=(Age >= 18)? "You are eligble":"You are not old enough"; //creating comparison response
    document.getElementById("can_vote").innerHTML=Can_Vote + "to vote"; //calling results to innerHTML
}
